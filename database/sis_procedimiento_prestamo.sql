...
CALL spu_libroentregado_register(7,1,1,'Nuevo','2023-11-12')
SELECT * FROM prestamos
...
CALL spu_registrar_prestamo_ahora(3,4, '3B','SI','')
...
CALL spu_libroentregado_AddAhora(9,2,1,'Nuevo','2023-11-19');
